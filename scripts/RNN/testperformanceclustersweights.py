...
NNmodels='/vol/work/mesa/NNearlystoppingweights/'
LSTMmodels='/vol/work/mesa/LSTMearlystoppingweights/'
...
for modeltype in modelslist: #we evaluate results on NN and LSTM models
	if 'LSTM' in modeltype:
		f=open('/vol/work/mesa/RESULTS/resultsLSTMearlystoppingweightsclusters','a')
	elif 'NN' in modeltype:
		f=open('/vol/work/mesa/RESULTS/resultsNNearlystoppingweightsclusters','a')
	...
	for nembedings in listdir(modeltype):
		...
		if 'embeding' in nembedings:	
			for nneurons in listdir(modeltype+nembedings):
				...
				f.write('2 '+str(contextaux[0])+' '+str(layeraux)+' '+str(pacc2)+' '+str(precision2)+' '+str(rapel2)+' '+str(fscore2a)+' '+str(fscore2b)+' '+str(fscore2c)+' '+str(pacc)+' '+str(totallines)+' '+str(int(pacc)/int(totallines))+' '+str(int(pacc)/int(totalprec))+'\n')	
